    ...
    <div className='about-container'>
      <div className='about-desc'>
        ...
        <div className='about-text'>
          Me dedico al desarrollo web hace 2 años, con buenos conocimientos tanto de backend como de frontend. Aceleré mi proceso de aprendizaje en la academia de <a href='https://soyhenry.com.ar' target='_blank'>Soy Henry</a>.
